...
const CreatePost = () => {
     ...
     return (
          <div className="p-5 w-full h-max border-solid border-2 border-sky-500 align-center rounded-2xl bg-sky-100 text-sky-800">
               ...
               <div className="flex gap-10 justify-center items-center mt-6">
                    ...
                    <div className="flex justify-center items-center gap-2 text-base cursor-pointer">Video</div>
                    <div className="flex justify-center items-center gap-2 text-base cursor-pointer"><BsCameraVideoFill /> <span>Write Artical</span></div>
               </div>
               <CreatePostModal
