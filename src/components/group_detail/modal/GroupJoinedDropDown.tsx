...
interface GroupJoinedDropdownProps {
    onClose: () => void;
}

const GroupJoinedDropdown: React.FC<GroupJoinedDropdownProps> = ({ onClose }) => {
    ...
    return (
        <div ref={menuRef} className="absolute top-[100%] mt-2 right-64 bg-white border rounded-lg shadow-lg w-80 z-50">
...
export default GroupJoinedDropdown;
