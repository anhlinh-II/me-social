...
const HomeView = () => {
  ...
  const hasFavorite = location.pathname.includes("favorite")
  ...
  const inHomeView: boolean = !hasListFriends && !hasProfile && !hasGroups && !hasSeemore && !hasFavorite ? true : false;
  return (
